...
// import {fa-instagram} from '/fontawesome'
// import {
//  faSquareTwitter
    ...
    <footer className="bg-green-600 text-white py-8 ">
      <div className="mx-auto text-center">
        <div className="flex flex-wrap justify-between mx-10">
          <div className="">
            <h4 className="text-xl font-semibold mb-3">Shop Categories</h4>
            <ul className="list-none gap-5 text-left">
              <li className="mb-2">
      ...
      <div className="mt-8 text-center">
        <p>&copy; {new Date().getFullYear()} Equip Farm Shop</p>
      </div>
    </footer>
  );
};
